assets {
  ...
  material "gold" { pbr = { base_color = "#d0da10ff", metallic = 1.0, roughness = 0.2 } }
}
...
entity "root" {
  ...
  children = [
    ...
    { name = "Box",    components = { MeshRef = { mesh = "cube"  }, StandardMaterialRef = { material = "gold" }, Transform = { t = [10,0.5,0] } } },
